...
$result = $conn->query("SELECT * FROM educ_attainment_vw") or die(mysqli_error($conn));
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h3 class="text-dark mb-4">Educational Attainment</h3>
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="educAttainmentTable">
                                    <thead>
                                        <tr>
                                            <th>Employee No.</th>
                                            <th>Name</th>
                                    ...
                                    <?php
                                        ...
                                        while ($rows = $result->fetch_assoc()):?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $rows['Degree_Code'];?></td>
